...
public class Compiler {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Build AST
        var ast_constructor_visitor = new Visitor_Parser();
        var ast = ast_constructor_visitor.visit(globalTree);
        // Populate global scope.
        SymbolTable.defineBasicClasses();

        // var printPassVisitor = new Visitor_Print();
        // ast.accept(printPassVisitor);

        var definitionPassVisitor = new Visitor_Definition();
        ast.accept(definitionPassVisitor);

        var resolutionPassVisitor = new Visitor_Resolution();
